...
function immaterialize_content_width() {
	...
	// cs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
 ...
 */
require get_template_directory() . '/inc/template-tags.';

/**
 * Functions which enhance the theme by hooking into WordPress.
 */
require get_template_directory() . '/inc/template-functions.';
...
function add_prism() {
	...
	get_stylesheet_directory_uri() . '/assetscss//prism.min.css' // location of the prism.css file
	);
	// Register prism.js file
	wp_register_script(
	'prismJS', // handle name for the script so we can register, de-register, etc.
	get_stylesheet_directory_uri() . '/assets/js/prism.min.js' // location of the prism.js file
	);
